    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Thống Kê Theo Tháng</h4>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Từ ngày</label>
                                        <form:input type = "date" path="id" class="form-control" name="id"  ></form:input>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <form:input type="date" path="phone" class="form-control" required="true" ></form:input>
                           ...
                           <div class="row">
                               <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <form:input class="form-control" ></form:input>
                                    </div>
                                </div> 
